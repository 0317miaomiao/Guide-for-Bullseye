...
### 1. Download Related Data (1_download_mut.sh and 1_download.sh)
...
#### Use Flexbar(3.5.0) for Adapter Trimming and Quality Cutting (2_flexbar.sh and 2_flexbar_mut.sh)
...
### 3. Use STAR(2.7.10b) to Generate BAM Files (3_star_1.sh and 3_star_2.sh)
...
```
### 4. BAM File Processing and Deduplication using SAMtools (4_dedup.sh and 4_dedup_mut.sh)
...
### 5. Generate Count Matrix Using Bullseye (5_bull_matrix.sh and 5_bull_mutmatrix.sh)
...
### 6. Add chr Prefix (6_change_to_chr.sh)
...
### 7. Generate Final Statistical Results Using Bullseye (7_bull_find_edit.sh)
...
### 8. Merge All Results (8_bull_merge_1.sh and 8_bull_merge_2.sh)
