#!/bin/bash
#SBATCH --job-name=run_parseBAM
#SBATCH -p kshcnormal
#SBATCH --ntasks=2
#SBATCH --cpus-per-task=32
#SBATCH --time=72:00:00
#SBATCH -o parseBAM_%j.out
#SBATCH -e parseBAM_%j.err

# 配置环境变量
BAM_DIR="bam_sort"
OUTPUT_DIR="bull_matrix"
...
# 获取所有 SRR 子目录名
find "$BAM_DIR" -maxdepth 1 -type d -name 'SRR*' | xargs -n 1 basename > bull_matrix.txt

cat bull_matrix.txt | xargs -P 6 -n 1 -I {} bash -c 'process_bam "$@"' _ {}
